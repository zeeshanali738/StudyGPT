...
export const BrainCircuitIcon: React.FC<IconProps> = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M12 10a2.5 2.5 0 0 1 3 4" />
        <path d="M12 10a2.5 2.5 0 0 0-3 4" />
        <path d="M12 22a2.5 2.5 0 0 1-3-4" />
        <path d="M12 22a2.5 2.5 0 0 0 3-4" />
        <path d="M17 9a2.5 2.5 0 0 1 3 4" />
        <path d="M17 9a2.5 2.5 0 0 0-3-4" />
        <path d="M7 9a2.5 2.5 0 0 1-3 4" />
        <path d="M7 9a2.5 2.5 0 0 0 3-4" />
        <path d="M17 15a2.5 2.5 0 0 1-3 4" />
        <path d="M17 15a2.5 2.5 0 0 0 3-4" />
        <path d="M7 15a2.5 2.5 0 0 1 3 4" />
        <path d="M7 15a2.5 2.5 0 0 0-3-4" />
        <path d="M12 6V5" />
        <path d="M12 19v-1" />
        <path d="m15.5 7.5-.86.5" />
        <path d="m8.5 7.5.86.5" />
        <path d="m15.5 16.5-.86-.5" />
        <path d="m8.5 16.5.86-.5" />
        <path d="M19 12h1" />
        <path d="M4 12h1" />
    </svg>
);
